...
import com.ramindu.weeraman.currencyrate.TIMEOUT_REQUEST
...
class NetModule(private val baseUrl: String) {
    ...
    @Provides
    @Singleton
    fun provideRetrofitService(builder: Retrofit.Builder): ExchangeRatesApiService = builder.baseUrl(baseUrl).build().create(
